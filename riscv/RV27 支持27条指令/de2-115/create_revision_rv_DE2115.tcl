## Create a new revision called "RV_DE2115"
## with settings based on "RV_Pocket"
## and set it as the current revision
create_revision RV_DE2115 -based_on RV_Pocket -set_current
...
# 移除生成rbf文件
remove_all_global_assignments -name GENERATE_RBF_FILE

# 移除原芯片型号
remove_all_global_assignments -name DEVICE

# 移除原顶层模块
remove_all_global_assignments -name TOP_LEVEL_ENTITY

# 添加顶层文件并设置为顶层模块
set_global_assignment -name VERILOG_FILE RV_DE2_115.v
set_global_assignment -name TOP_LEVEL_ENTITY RV_DE2_115
